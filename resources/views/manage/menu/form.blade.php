...
<div class="box-body">
    <div class="form-group row {{ $errors->has('menu_title') ? ' has-error' : '' }}">
        ...
        <div class="col-sm-9">
            {!! Form::text('menu_title',null,['class' => 'form-control ' , 'required' =>'true']) !!}
...
<div class="box-body">
    <div class="form-group row {{ $errors->has('menu_desc') ? ' has-error' : '' }}">
        ...
        <div class="col-sm-9">
            {!! Form::text('menu_desc',null,['class' => 'form-control ' , 'required' =>'true']) !!}
...
<div class="box-body">
    <div class="form-group row {{ $errors->has('menu_url') ? ' has-error' : '' }}">
        ...
        <div class="col-sm-9">
            {!! Form::text('menu_url',null,['class' => 'form-control ' , 'required' =>'true']) !!}
...
<div class="box-body">
    <div class="form-group row {{ $errors->has('menu_st') ? ' has-error' : '' }}">
        ...
        <div class="col-sm-2">
            {!! Form::select('menu_st', ['internal' => 'Internal', 'external'=>'External'] , null, ['class' => 'form-control select2 select2-hidden-accessible pr-0', 'style' => 'width: 100%', "tabindex" => "-1" , "aria-hidden" => "true"] ); !!}
            @if ($errors->has('menu_st'))
                <span class="help-block">
                    <strong>{{ $errors->first('menu_st') }}</strong>
                </span>
            @endif
        </div>
    </div>
...
<div class="box-body">
    <div class="form-group row {{ $errors->has('active_st') ? ' has-error' : '' }}">
        ...
        <div class="col-sm-2">
            {!! Form::select('active_st', ['yes' => 'Yes', 'no' => 'No'] , null, ['class' => 'form-control select2 select2-hidden-accessible pr-0', 'style' => 'width: 100%', "tabindex" => "-1" , "aria-hidden" => "true"] ); !!}
            @if ($errors->has('active_st'))
                <span class="help-block">
                    <strong>{{ $errors->first('active_st') }}</strong>
                </span>
            @endif
        </div>
    </div>
...
<div class="box-body">
    <div class="form-group row {{ $errors->has('display_st') ? ' has-error' : '' }}">
        ...
        <div class="col-sm-2">
            {!! Form::select('display_st', ['yes' => 'Yes', 'no' => 'No'] , null, ['class' => 'form-control select2 select2-hidden-accessible pr-0', 'style' => 'width: 100%', "tabindex" => "-1" , "aria-hidden" => "true"] ); !!}
            @if ($errors->has('display_st'))
                <span class="help-block">
                    <strong>{{ $errors->first('display_st') }}</strong>
                </span>
            @endif
        </div>
    </div>
...
<div class="box-body">
    <div class="form-group row {{ $errors->has('menu_target') ? ' has-error' : '' }}">
        ...
        <div class="col-sm-2">
            {!! Form::select('menu_target', ['self' => 'Self', 'blank' => 'Blank'] , null, ['class' => 'form-control select2 select2-hidden-accessible pr-0', 'style' => 'width: 100%', "tabindex" => "-1" , "aria-hidden" => "true"] ); !!}
            @if ($errors->has('menu_target'))
                <span class="help-block">
                    <strong>{{ $errors->first('menu_target') }}</strong>
                </span>
            @endif
        </div>
    </div>
                    ...
                    <div class="panel-group panel-group-simple panel-group-continuous" id="accordion2" aria-multiselectable="true" role="tablist">
                        ...
                        <div class="panel">
                            <div class="panel-heading" id="question-1" role="tab">
                                <a class="panel-title collapsed" aria-controls="answer-1" aria-expanded="false" data-toggle="collapse" href="#answer-1" data-parent="#accordion2">
                                    Material Icon
                                </a>
                            </div>
                            <div class="panel-collapse collapse" id="answer-1" aria-labelledby="question-1" role="tabpanel" style="">
                                <div class="panel-body">
                                    ...
                                    <div class="row list-icon">
                                        @foreach($data_icon as $icon)
                                            <li class="col-md-1 col-sm-2" style="list-style-type: none">
                                                <i class="material-icons" style="cursor: pointer">{{ $icon }}</i>
                                            </li>
                                        @endforeach
                                    </div>
                                </div>
...
@section('custom-js')
    <script type="text/javascript">
        ...
        setFormValidation('#form-menu');
        // init select 2
        $('.select2').select2();
        $('.list-icon li').each(function(){
            $(this).attr('data-search-term', $(this).find('i').text().toLowerCase());
        });
        ...
        $('.material-icons').click(function () {
            ...
            $('.input-group-addon').append('<i class="material-icons" style="cursor: pointer">'+icon+'</i>');
        });
