        ...
        <div class="row">
            <div class="col-xl-12 col-md-12 col-lg-12">
                ...
                <div class="box">
                    ...
                    <!-- form start -->
                    {!! Form::model($menu = new \App\Model\Manage\Menu(),['route' => 'manage.menu.store', 'class' => 'form-horizontal form-element', 'id' => 'tambah-menu']) !!}
                        @include('manage.menu.form',['textButton' => 'Simpan', 'iconButton' => 'mdi mdi-plus'])
                    {!! Form::close() !!}
                </div>
                <!-- /.box -->
            </div>
