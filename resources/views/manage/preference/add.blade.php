        ...
        <div class="row">
            <div class="col-xl-12 col-md-12 col-lg-12">
                ...
                <div class="box">
                    ...
                    <!-- form start -->
                    {!! Form::model($preference = new \App\Model\Manage\Preference(),['route' => 'manage.preference.store', 'class' => 'form-horizontal form-element','enctype'=>"multipart/form-data", 'id' => 'tambah-preference']) !!}
                        @include('manage.preference.form',['textButton' => 'Simpan', 'icon' => 'mdi mdi-plus'])
                    {!! Form::close() !!}
                </div>
                <!-- /.box -->
            </div>
...
@section('custom-js')
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            setFormValidation('#tambah-preference');
        });
    </script>
@endsection