        ...
        <div class="row">
            <div class="col-xl-12 col-md-12 col-lg-12">
                ...
                <div class="box">
                    ...
                    <!-- form start -->
                    {!! Form::model($user = new \App\Model\Manage\UserLogin(),['route' => 'manage.user.store', 'class' => 'validation-wizard wizard-circle','enctype'=>'multipart/form-data', 'id' => 'tambah-user']) !!}
